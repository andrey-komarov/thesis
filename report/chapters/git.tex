...
изображён на рисунке~\ref{fig:git-checkout-master}. После объединения
создаётся новый коммит, предками которого являются коммиты, на которые
указывали все объединяемые ветки. 
