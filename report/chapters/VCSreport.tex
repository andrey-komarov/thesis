...
\\
\>[4]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaSymbol{→} \AgdaSymbol{(((}\AgdaBound{a} \AgdaFunction{∧ₚ} \AgdaBound{b}\AgdaSymbol{)} \AgdaBound{a∥b}\AgdaSymbol{)} \AgdaFunction{⋙ₚ} \AgdaSymbol{((}\AgdaBound{c'} \AgdaFunction{∧ₚ} \AgdaBound{c''}\AgdaSymbol{)} \AgdaBound{c'∥c''}\AgdaSymbol{))} \AgdaBound{a∧b⋙?c} \<[56]%
\>[56]\<%
\\
\>[6]\AgdaIndent{8}{}\<[8]%
