...
\tikzset{vecpatch-tiny/.style={vecpatch, minimum height=0.6cm}}
...
\tikzset{vecpatch-form/.style={vecpatch-tiny,fill=blue!40!white}}

\tikzset{treev/.style={draw=black,circle}}
