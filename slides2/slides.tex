...
\input{src/08-defs.tex}
\input{src/09-known.tex}
\input{src/10-aim.tex}
\input{src/11-plan.tex}
\input{src/15-repotypes.tex}
\input{src/20-form.tex}
%у меня этот слайд не компилиться
%%а что говорит?
\input{src/30-trees.tex}
\input{src/40-form-conflicts.tex}
\input{src/50-vec-ops.tex}
\input{src/55-tree-ops.tex}
\input{src/60-equiv.tex}
\input{src/65-equiv-prop.tex}
%\input{src/90-conclusion.tex}
\input{src/90-results.tex}
\input{src/99-questions.tex}
